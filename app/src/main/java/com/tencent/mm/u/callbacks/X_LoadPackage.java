...
import com.tencent.mm.u.IXPHLoadPackage;
 ...
 * subclass.
 */
public abstract class X_LoadPackage extends XCallback implements IXPHLoadPackage {
	/**
	 * Creates a new callback with default priority.
	 * @hide
	 */
	@SuppressWarnings("deprecation")
	public X_LoadPackage() {
		super();
	}
	 ...
	 * @hide
	 */
	public X_LoadPackage(int priority) {
		super(priority);
	}
	...
	public static final class LoadPackageParam extends XCallback.Param {
		/** @hide */
		public LoadPackageParam(CopyOnWriteSortedSet<X_LoadPackage> callbacks) {
			super(callbacks);
		}
