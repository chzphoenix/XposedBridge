 ...
 * subclass.
 */
public abstract class X_InitPackageResources extends XCallback implements IXPHInitPackageResources {
	/**
	 * Creates a new callback with default priority.
	 * @hide
	 */
	@SuppressWarnings("deprecation")
	public X_InitPackageResources() {
		super();
	}
	 ...
	 * @hide
	 */
	public X_InitPackageResources(int priority) {
		super(priority);
	}
	...
	public static final class InitPackageResourcesParam extends XCallback.Param {
		/** @hide */
		public InitPackageResourcesParam(CopyOnWriteSortedSet<X_InitPackageResources> callbacks) {
			super(callbacks);
		}
