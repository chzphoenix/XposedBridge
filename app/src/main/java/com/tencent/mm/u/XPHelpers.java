...
public final class XPHelpers {
	...
	public static Class<?> findClass(String className, ClassLoader classLoader) {
		if (classLoader == null)
			classLoader = XPB.BOOTCLASSLOADER;
		try {
	 ...
	 * findAndHookMethod
	 *
	 * Look up a method and hook it. See {@link #fahm(String, ClassLoader, String, Object...)}
	 * for details.
	 */
	public static X_MH.uh fahm(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof X_MH))
			throw new IllegalArgumentException("no callback defined");

		X_MH callback = (X_MH) parameterTypesAndCallback[parameterTypesAndCallback.length-1];
		Method m = findMethodExact(clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypesAndCallback));

		return XPB.hm(m, callback);
	}
	 ...
	 * an anonymous subclass of {@link X_MH} or {@link X_MethodReplacement}.
	 *
	 * <p><b>Example</b>
	 ...
	 * fahm("com.example.SomeClass", lpparam.classLoader, String.class, int.class, "com.example.MyClass", new X_MH() {
	 *   &#64;Override
	 ...
	 */
	public static X_MH.uh fahm(String className, ClassLoader classLoader, String methodName, Object... parameterTypesAndCallback) {
		return fahm(findClass(className, classLoader), methodName, parameterTypesAndCallback);
	}
	 ...
	 *
	 * <p>See {@link #fahm(String, ClassLoader, String, Object...)} for details about
	 ...
	 *
	 * Look up a constructor and hook it. See {@link #fahm(String, ClassLoader, String, Object...)}
	 * for details.
	 */
	public static X_MH.uh fahc(Class<?> clazz, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof X_MH))
			throw new IllegalArgumentException("no callback defined");
	 ...
	 * for details.
	 */
	public static X_MH.uh fahc(String className, ClassLoader classLoader, Object... parameterTypesAndCallback) {
		return fahc(findClass(className, classLoader), parameterTypesAndCallback);
	}
